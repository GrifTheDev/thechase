...
{:else}
  ...
  <div class="m-4"></div>
  <button class="w-screen h-1/5 text-white text-center border-2 border-solid border-white rounded-2xl bg-gradient-to-b from-question-answer-popout-start to-question-answer-popout-end text-3xl active:border-8 active:scale-95 select-none">{answerA}</button>
  <button class="mt-2 mb-2 w-screen h-1/5 text-white text-center border-2 border-solid border-white rounded-2xl bg-gradient-to-b from-question-answer-popout-start to-question-answer-popout-end text-3xl active:border-8 active:scale-95 select-none">{answerB}</button>
  <button class="w-screen h-1/5 text-white text-center border-2 border-solid border-white rounded-2xl bg-gradient-to-b from-question-answer-popout-start to-question-answer-popout-end text-3xl active:border-8 active:scale-95 select-none">{answerC}</button>
{/if}
</div>